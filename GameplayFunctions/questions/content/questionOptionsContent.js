...
const overallBattingStats = [
  ...
  // {whatToSet: [{key: 'statCategory', value: 'adjBA', skeletonType: {stat: {verb: [`had`], objectNoun: [`Batting Avg`]}}}, {key: 'mostOrLeast', value: 'most', skeletonType: {stat: {mostOrLeast: [`most`]}}}], weight: 300},
...
const comparisonBattingStats = [
  ...
  // {whatToSet: [{key: 'statCategory', value: 'adjBA', skeletonType: {stat: {verb: [`had`], objectNoun: [`batting AVG`]}}}], weight: 300, nextChoice: mostOrLeast},

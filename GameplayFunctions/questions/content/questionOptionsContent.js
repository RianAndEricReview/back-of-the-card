...
const overallTeamStats = [
  ...
  { whatToSet: [{ key: 'statCategory', value: 'SO', skeletonType: { stat: { verb: [`struck out`] } } }], weight: 2, nextChoice: mostOrLeast },
...
const comparisonPlayerBattingStats = [
  ...
  { whatToSet: [{ key: 'statCategory', value: '2B', skeletonType: { stat: { verb: [`hit`], objectNoun: [`doubles`] } } }], weight: 3, nextChoice: mostOrLeast },
  { whatToSet: [{ key: 'statCategory', value: '3B', skeletonType: { stat: { verb: [`legged out`], objectNoun: [`triples`] } } }], weight: 3, nextChoice: mostOrLeast },
  { whatToSet: [{ key: 'statCategory', value: 'BA', skeletonType: { stat: { verb: [`had`], objectNoun: [`batting AVG`] } } }], weight: 3, nextChoice: mostOrLeast },
...
const overallPlayerTimeframe = [
  { whatToSet: [{ key: 'timeFrame', value: 'singleSeason', skeletonType: { stat: { timeFrame: [` in `] } } }], weight: 4, nextChoice: overallPlayerBattingStats },
...
const overallTeamOrPlayer = [
  { whatToSet: [{ key: 'teamOrPlayer', value: 'singlePlayer', skeletonType: { stat: { subjectNoun: [`player`] } } }], weight: 3, nextChoice: overallPlayerTimeframe },
  { whatToSet: [{ key: 'teamOrPlayer', value: 'wholeTeam', skeletonType: { stat: { subjectNoun: [`team`] } } }], weight: 1, nextChoice: overallTeamTimeframe }
]

const comparisonTeamOrPlayer = [
  { whatToSet: [{ key: 'teamOrPlayer', value: 'singlePlayer', skeletonType: { stat: { subjectNoun: [`player`] } } }], weight: 3, nextChoice: comparisonPlayerTimeframe },
  { whatToSet: [{ key: 'teamOrPlayer', value: 'wholeTeam', skeletonType: { stat: { subjectNoun: [`team`] } } }], weight: 1, nextChoice: comparisonTeamTimeframe }
]


const questionType = [
  { whatToSet: [{ key: 'questionType', value: 'comparison', skeletonType: { stat: { comparativePhrasing: [`of these`], pluralization: [`s`] } } }], weight: 2, nextChoice: comparisonTeamOrPlayer },
